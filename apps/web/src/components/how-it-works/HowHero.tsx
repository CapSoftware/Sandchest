export default function HowHero() {
  return (
    <section className="flex flex-col" style={{ padding: 'var(--vertical-padding) var(--padding)' }}>
      ...
      >
        Add the SDK to your agent, create a sandbox, and start running code.
        Every sandbox is a Firecracker microVM on bare metal &mdash; isolated,
        forkable, and fully replayable.
      </p>
    </section>
  )
}
