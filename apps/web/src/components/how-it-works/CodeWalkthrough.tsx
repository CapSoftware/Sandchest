  ...
  return (
    <section className="section">
      <div className="section-header">
        <h2 className="section-title">Full example</h2>
        <p className="text-text" style={{ maxWidth: '72ch' }}>
          A complete agent workflow: create a sandbox, set up the environment, fork to try something risky, and keep only what works.
        </p>
      </div>
      ...
      <div style={{ borderRadius: 6, overflow: 'hidden' }}>
        ...
        <pre className="bg-surface overflow-x-auto code-block" style={{ padding: 20, lineHeight: 1.75 }}>
          <code>
            ...
            <span className="text-text-weak">);</span>
            {'\n\n'}
            <span className="text-border">{'// Keep or discard based on the result'}</span>
            {'\n'}
            ...
            <span className="text-text-weak">{'}'}</span>
            {'\n\n'}
            <span className="text-border">{'// Share the replay URL'}</span>
            {'\n'}
            <span className="text-text-weak">console.</span>
            <span className="text-text">log</span>
            <span className="text-text-weak">(</span>
            <span className="text-text-strong">sb</span>
            <span className="text-text-weak">.</span>
            <span className="text-text">replayUrl</span>
            <span className="text-text-weak">);</span>
          </code>
        </pre>
      </div>
