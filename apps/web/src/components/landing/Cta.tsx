      ...
      <div className="cta-layout">
        <div className="cta-content">
          ...
          <div className="cta-buttons">
            <a href="https://github.com/CapSoftware/Sandchest" className="star-btn no-underline hover:no-underline" target="_blank" rel="noopener">
            ...
            <a href="https://github.com/CapSoftware/Sandchest" className="follow-btn no-underline hover:no-underline" target="_blank" rel="noopener">
              View Repository
